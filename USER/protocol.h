...
******************************************************************************/
#define PRODUCT_KEY "wt8ht3j3kkrla0qm"    //The unique product identification generated after product is created on development platform
...
//Tomato clock(可下发可上报)
//Notes:
#define DPID_SWITCH_TOMATOCLOCK 51
//Reminder time(可下发可上报)
//Notes:
#define DPID_TOMATOCLOCK_TIME 52
